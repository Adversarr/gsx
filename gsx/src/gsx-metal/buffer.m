...
)
{
    ...
    (void)out_rank;
    (void)out_shape;
    return gsx_make_error(GSX_ERROR_NOT_SUPPORTED, "metal gather_tensor is not implemented");
}
...
)
{
    ...
    (void)out_rank;
    (void)out_shape;
    return gsx_make_error(GSX_ERROR_NOT_SUPPORTED, "metal resize_tensor is not implemented");
}
...
)
{
    ...
    (void)rank;
    (void)shape;
    return gsx_make_error(GSX_ERROR_NOT_SUPPORTED, "metal exp_tensor is not implemented");
}
