...
static gsx_error gsx_cpu_adc_zero_growth_optim_state(const gsx_adc_request *request, gsx_size_t old_count, gsx_size_t new_count)
{
...
static gsx_error gsx_cpu_adc_reset_post_refine_aux(gsx_gs_t gs)
{
